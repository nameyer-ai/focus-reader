...
`;
  ...
  {confirmingReset ? '⚠️ Click again to confirm' : 'Reset Stats'}
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap' }}>
          ...
          <button onClick={downloadReport} style={{ padding: '1rem 2rem', backgroundColor: 'rgba(255,255,255,0.1)', color: textColor, border: 'none', borderRadius: '12px', cursor: 'pointer', fontSize: '1.125rem', display: 'flex', alignItems: 'center', gap: '0.75rem', transition: 'all 0.2s' }}>
  ...
  style={{
    padding: '1rem 2rem',
    backgroundColor: confirmingReset ? '#c53030' : 'rgba(255,100,100,0.15)',
    color: confirmingReset ? 'white' : '#ff6b6b',
    border: '1px solid rgba(255,100,100,0.3)',
    borderRadius: '12px', cursor: 'pointer', fontSize: '1.125rem',
    display: 'flex', alignItems: 'center', gap: '0.75rem', transition: 'all 0.2s'
  }}>
  <RotateCcw size={24} /> {confirmingReset ? '⚠️ Click again to confirm' : 'Reset Stats'}
</button>
        </div>
